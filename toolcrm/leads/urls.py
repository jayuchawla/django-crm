...
from .views import add_lead, leads_list, lead_detail, lead_delete, edit_lead, convert_to_client
urlpatterns = [
    ...
    path(route='<int:pk>/convert/', view=convert_to_client, name='convert_to_client'),
]